...
var _getHeroHeight = require("./utils/getHeroHeight");
var _getToursHeight = require("./utils/getToursHeight");
var _videoPlayer = require("./modules/video-player");
var _audioPlayer = require("./modules/audio-player");
var _initHeroSlider = require("./modules/initHeroSlider");
var _initToursSlider = require("./modules/initToursSlider");
var _initEducationSlider = require("./modules/initEducationSlider");
var _initReviewsSlider = require("./modules/initReviewsSlider");
var _initFeaturesSlider = require("./modules/initFeaturesSlider");
var _initGallerySlider = require("./modules/initGallerySlider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  burger.init();
  (0, _getHeroHeight.getHeroHeight)();
  (0, _initHeroSlider.initHeroSlider)();
  (0, _getToursHeight.getToursHeight)();
  ...
  window.addEventListener('load', function () {
    (0, _videoPlayer.playVideo)();
    (0, _audioPlayer.playAudio)();
    (0, _initToursSlider.initToursSlider)();
    (0, _initEducationSlider.initEducationSlider)();
    (0, _initReviewsSlider.initReviewsSlider)();
    (0, _initFeaturesSlider.initFeaturesSlider)();
...
var playAudio = function playAudio() {
  if (document.querySelector('[data-id="audio"]')) {
    var audioPlayer = document.querySelector('[data-id="audio"]');
    var audioButton = audioPlayer.querySelector('[data-audio__play]');
    var iframe = "<iframe frameborder=\"0\" style=\"border:none;width:340px;height:220px;\" width=\"340\" height=\"220\" src=\"".concat(audioPlayer.dataset.src, "\">\u0421\u043B\u0443\u0448\u0430\u0439\u0442\u0435 <a href='").concat(audioPlayer.dataset.href, "'>001. \u041A\u043E\u043D\u0435\u0446 \u0444\u0440\u043E\u043D\u0442\u0435\u043D\u0434\u0430, \u043E\u0434\u0438\u043D\u0430\u043A\u043E\u0432\u044B\u0435 \u0444\u0440\u0435\u0439\u043C\u0432\u043E\u0440\u043A\u0438 \u0438 \u043B\u043E\u0433\u0438\u0447\u0435\u0441\u043A\u0438\u0435 \u0441\u0432\u043E\u0439\u0441\u0442\u0432\u0430</a> \u043D\u0430 \u042F\u043D\u0434\u0435\u043A\u0441 \u041C\u0443\u0437\u044B\u043A\u0435</iframe>");
...
var editInputsPlaceholder = function editInputsPlaceholder() {
...
exports.editInputsPlaceholder = editInputsPlaceholder;
...
},{"./callback":3,"./init-phone-input":6,"./validator":10}],6:[function(require,module,exports){
"use strict";
...
},{"./focus-lock":12,"./scroll-lock":14}],12:[function(require,module,exports){
"use strict";
...
exports.initEducationSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initEducationSlider = function initEducationSlider() {
  if (!document.querySelector('[data-education__slider]')) {
    return null;
  }
  var educationSliderElement = document.querySelector('[data-education__slider]');
  var educationSlider = new _swiper.default(educationSliderElement, {
    simulateTouch: false,
    grabCursor: false,
    watchOverflow: true,
    speed: 300,
...
exports.initEducationSlider = initEducationSlider;
...
exports.initFeaturesSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var createFeaturesSlider = function createFeaturesSlider() {
  var featuresSlider = document.querySelector('[data-features__slider]');
  if (featuresSlider) {
    return new _swiper.default(featuresSlider, {
      simulateTouch: false,
      grabCursor: false,
      watchOverflow: true,
      speed: 300,
...
var initFeaturesSlider = function initFeaturesSlider() {
  ...
  var isValid = function isValid() {
    var desktopWidth = window.matchMedia('(min-width: 1199px)');
...
exports.initFeaturesSlider = initFeaturesSlider;
...
var initGallerySlider = function initGallerySlider() {
  ...
  var gallerySliderElement = document.querySelector('[data-gallery__slider]');
  var gallerySlider = new _swiper.default(gallerySliderElement, {
    simulateTouch: false,
    grabCursor: false,
    watchOverflow: true,
    speed: 300,
...
var initHeroSlider = function initHeroSlider() {
  ...
  var heroSliderElement = document.querySelector('[data-hero__slider]');
  var initActiveSlide = function initActiveSlide() {
    if (document.querySelector('.swiper-slide-active')) {
      ...
      allSlides.forEach(function (slide) {
        if (slide.querySelectorAll('a')) {
          slide.querySelectorAll('a').forEach(function (slideLink) {
            slideLink.removeAttribute('tabindex');
            slideLink.setAttribute('tabindex', '-1');
          });
        }
        if (slide.querySelectorAll('button')) {
          slide.querySelectorAll('button').forEach(function (slideButton) {
      ...
      if (activeSlide.querySelectorAll('a')) {
        var slideLinks = activeSlide.querySelectorAll('a');
      ...
      if (activeSlide.querySelectorAll('button')) {
        var slideButtons = activeSlide.querySelectorAll('button');
  ...
  var heroSlider = new _swiper.default(heroSliderElement, {
    simulateTouch: false,
    grabCursor: false,
    watchOverflow: true,
    speed: 300,
    ...
    on: {
      init: function init() {
        var duplicatedSlides = document.querySelectorAll('[class*="duplicate"]');
        duplicatedSlides.forEach(function (slide) {
      ...
      slideChange: function slideChange() {
        ...
        if (document.querySelector('.swiper-slide-active').querySelector('a')) {
          var slideLink = document.querySelector('.swiper-slide-active').querySelector('a');
          slideLink.focus();
        }
      },
...
},{"../modules/audio-player":2,"../modules/video-player":22,"../vendor/swiper":28}],19:[function(require,module,exports){
"use strict";
...
var mapImgContainer = document.querySelector('.map__img-container');
var initMap = function initMap() {
  if (mapContainer) {
    mapImgContainer.classList.add('map__img-container--hide');
    var coordinate = [55.774836, 37.632664];
...
},{"../vendor/leaflet":27}],20:[function(require,module,exports){
"use strict";
...
var initReviewsSlider = function initReviewsSlider() {
  ...
  var reviewsSliderElement = document.querySelector('[data-reviews__slider]');
  var reviewsSlider = new _swiper.default(reviewsSliderElement, {
    simulateTouch: false,
    grabCursor: false,
    watchOverflow: true,
    speed: 300,
...
var initToursSlider = function initToursSlider() {
  ...
  var toursSliderElement = document.querySelector('[data-tours__slider]');
  var toursSlider = new _swiper.default(toursSliderElement, {
    simulateTouch: false,
    grabCursor: false,
    watchOverflow: true,
    speed: 300,
...
var playVideo = function playVideo() {
  if (document.querySelector('[data-id="video"]')) {
    var videoPlayer = document.querySelector('[data-id="video"]');
    var videoBtnPlay = document.querySelector('.video__btn');
    videoPlayer.addEventListener('click', function () {
      var iframe = "<iframe id=\"youtube-video\" src=\"".concat(videoPlayer.dataset.src, "\" title=\"\u0411\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u044B\u0435 \u0438\u043D\u0442\u0435\u0440\u0430\u043A\u0442\u0438\u0432\u043D\u044B\u0435 \u043E\u043D\u043B\u0430\u0439\u043D-\u043A\u0443\u0440\u0441\u044B.\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>");
...
exports.getHeroHeight = void 0;
var getHeroHeight = function getHeroHeight() {
  if (document.querySelector('[data-header-element]')) {
    var headerElement = document.querySelector('[data-header]');
    var heroElement = document.querySelector('[data-hero]');
    var contentElements = heroElement.querySelectorAll('[data-hero-content]');
...
exports.getHeroHeight = getHeroHeight;
...
exports.getToursHeight = void 0;
var getToursHeight = function getToursHeight() {
  if (document.querySelector('[data-header-element]')) {
    var toursSidesContent = document.querySelectorAll('[data-tours-slide__content]');
    var maxHeight = 0;
    var setHeight = function setHeight(elements) {
      elements.forEach(function (toursSideContent) {
        var elementHeight = toursSideContent.offsetHeight;
        if (elementHeight > maxHeight) {
          maxHeight = elementHeight;
        }
        toursSideContent.style.marginTop = "-".concat(maxHeight, "px");
      });
    };
...
exports.getToursHeight = getToursHeight;
