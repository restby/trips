...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initSwiper.initToursSlider)();
    (0, _videoPlayer.play)();
    (0, _initSwiper.initEducationSlider)();
    (0, _initSwiper.initReviewsSlider)();
    (0, _initSwiper.initFeaturesSlider)();
    (0, _initSwiper.initGallerySlider)();
...
},{"./modules/form-validate/form":4,"./modules/form-validate/form-fields":3,"./modules/header/burger":10,"./modules/video-player":14,"./utils/ios-vh-fix":16,"./vendor/init-leaflet":17,"./vendor/init-swiper":18}],2:[function(require,module,exports){
"use strict";
...
},{"./callback":2,"./init-phone-input":5,"./validator":9}],5:[function(require,module,exports){
"use strict";
...
},{"./focus-lock":11,"./scroll-lock":13}],11:[function(require,module,exports){
"use strict";
...
exports.initToursSlider = exports.initReviewsSlider = exports.initHeroSlider = exports.initGallerySlider = exports.initFeaturesSlider = exports.initEducationSlider = void 0;
...
var initEducationSlider = function initEducationSlider() {
  if (educationSlider) {
    var swiper = new Swiper(educationSlider, {
      simulateTouch: false,
      grabCursor: false,
      watchOverflow: true,
      speed: 500,
