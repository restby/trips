...
var getHeight = function getHeight() {
  if (document.querySelector('[data-header-element]')) {
    ...
    var contentElement = heroElement.querySelector('[data-hero-content]');
    var setHeight = function setHeight() {
      heroElement.style.marginTop = "-".concat(headerElement.offsetHeight + 41, "px");
      contentElement.style.paddingTop = "".concat(headerElement.offsetHeight + 120, "px");
    };
