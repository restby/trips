...
var initHeroSlider = function initHeroSlider() {
  ...
  var pauseVideoAndReloadIframe = function pauseVideoAndReloadIframe() {
    if (heroSlider.querySelector('iframe')) {
      var iframe = heroSlider.querySelector('iframe');
      var removeAutoplayParameter = function removeAutoplayParameter(url) {
        var parts = url.split('?');
        if (parts.length > 1) {
      ...
      var cleanUrl = removeAutoplayParameter(videoUrl);
      iframe.src = cleanUrl;
    }
  };
