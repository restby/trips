...
var initEducationSlider = function initEducationSlider() {
  ...
  var educationSlider = document.querySelector('[data-education__slider]');
  return new _swiper.default(educationSlider, {
    simulateTouch: false,
    grabCursor: false,
    watchOverflow: true,
    speed: 300,
...
var initGallerySlider = function initGallerySlider() {
  ...
  var gallerySlider = document.querySelector('[data-gallery__slider]');
  return new _swiper.default(gallerySlider, {
    simulateTouch: false,
    grabCursor: false,
    watchOverflow: true,
    speed: 300,
...
var initHeroSlider = function initHeroSlider() {
  ...
  var heroSlider = document.querySelector('[data-hero__slider]');
...
var initReviewsSlider = function initReviewsSlider() {
  ...
  var reviewsSlider = document.querySelector('[data-reviews__slider]');
...
var initToursSlider = function initToursSlider() {
  ...
  var toursSlider = document.querySelector('[data-tours__slider]');
